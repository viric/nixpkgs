...
let basename = "binutils-2.22.90"; in
stdenv.mkDerivation rec {
  name = basename + stdenv.lib.optionalString (cross != null) "-${cross.config}";

  src = fetchurl {
    #url = "mirror://gnu/binutils/${basename}.tar.bz2";
    url = ftp://sourceware.org/pub/binutils/snapshots/binutils-2.22.90.tar.bz2;
    sha256 = "1l2hljmc3gl6gqc836l6fdil7x22r2rh0l5rz5l0cq714zzrfz2b";
  };
